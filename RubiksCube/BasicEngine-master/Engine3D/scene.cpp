...
#include <iostream>
	...
	void Scene::MouseProccessing(int button)
	{
		...
		/*		MyTranslate(glm::vec3(-xrel/20.0f,0,0),0);
				...
				WhenTranslate();*/
				MoveCamera(cameraIndx,xTranslate, (xrel / 100.0f));
				MoveCamera(cameraIndx,yTranslate, (-yrel / 100.0f));
			...
			/*	MyRotate(xrel/2.0f,glm::vec3(1,0,0),0);
				...
				WhenRotate();*/
				MoveCamera(cameraIndx,xRotate, (yrel / 2.0f));
				MoveCamera(cameraIndx,yRotate, (xrel / 2.0f));
